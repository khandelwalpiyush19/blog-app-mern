...
function Sidebar({ setComponent }) {
  ...
  const handleLogout = async (e) => {
    ...
    try {
      const { data } = await axios.get(
        "https://blog-app-mern-yfob.onrender.com/api/users/logout",
  ...
  return (
    <>
      ...
      <div
        className={`w-56 h-full shadow-lg fixed top-0 left-0 bg-gray-50 transition-transform duration-300 transform sm:translate-x-0 ${
